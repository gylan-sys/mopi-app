  ...
  return (
    ...
    >
      <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div>
          <p className="text-coffee-400 font-sans font-bold uppercase tracking-[0.2em] text-[10px] mb-2">Layanan Antar</p>
          <h2 className="text-4xl font-serif text-coffee-950 tracking-tight">
            Delivery & <span className="text-coffee-400">Driver</span>
          </h2>
        </div>
        <div className="flex items-center gap-4">
          ...
          <div className="bg-coffee-950 text-white px-6 py-3.5 rounded-2xl text-[10px] font-sans font-bold uppercase tracking-widest flex items-center gap-3 shadow-xl shadow-coffee-950/20 premium-shadow">
            <Truck size={18} className="text-coffee-400" />
      ...
      <div className="grid grid-cols-1 gap-8">
        ...
        <motion.div 
          ...
          className="glass-card p-8 bg-white border border-coffee-100 shadow-xl relative overflow-hidden"
        >
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 mb-8">
            <div className="flex items-center gap-4">
              <div className="bg-coffee-50 p-3 rounded-2xl text-coffee-950 border border-coffee-100">
                <Globe size={24} />
              </div>
              <div>
                <h3 className="text-xl font-serif font-bold text-coffee-950 tracking-tight">Monitoring Driver</h3>
                <p className="text-[10px] text-coffee-400 font-sans font-bold uppercase tracking-widest">Posisi real-time driver aktif</p>
              </div>
            </div>
            <button 
              onClick={() => {
              ...
              className="text-[10px] font-sans font-bold text-coffee-400 uppercase tracking-[0.2em] hover:text-coffee-950 transition-colors flex items-center gap-2 group"
            >
              Kelola Driver <ArrowRight size={14} className="group-hover:translate-x-1 transition-transform" />
            </button>
          </div>
          <div className="rounded-[2rem] overflow-hidden border border-coffee-100 shadow-inner h-[550px] relative">
            <DriverMap 
              drivers={drivers} 
