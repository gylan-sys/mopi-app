...
const ReportsTab: React.FC<ReportsTabProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap items-center gap-2 bg-white/50 backdrop-blur-sm p-1.5 rounded-2xl border border-coffee-100 shadow-sm w-full no-print safe-top">
        <button 
          onClick={() => setReportSubTab('transactions')}
          className={cn(
            "px-6 py-2.5 rounded-xl text-[11px] sm:text-xs font-sans font-bold uppercase tracking-widest transition-all",
            reportSubTab === 'transactions' ? "bg-accent-500 text-white shadow-lg premium-shadow" : "text-coffee-400 hover:text-coffee-600"
          )}
        >
          Laporan Transaksi
        </button>
        <button 
          ...
          className={cn(
            "px-6 py-2.5 rounded-xl text-[11px] sm:text-xs font-sans font-bold uppercase tracking-widest transition-all",
            reportSubTab === 'daily-summary' ? "bg-accent-500 text-white shadow-lg premium-shadow" : "text-coffee-400 hover:text-coffee-600"
          )}
        >
          Ringkasan Harian
        </button>
        {user.role === 'admin' && (
          <>
            <button 
              ...
              className={cn(
                "px-6 py-2.5 rounded-xl text-[11px] sm:text-xs font-sans font-bold uppercase tracking-widest transition-all",
                reportSubTab === 'financial' ? "bg-accent-500 text-white shadow-lg premium-shadow" : "text-coffee-400 hover:text-coffee-600"
              )}
            >
              Laporan Keuangan
            </button>
            <button 
              ...
              className={cn(
                "px-6 py-2.5 rounded-xl text-[11px] sm:text-xs font-sans font-bold uppercase tracking-widest transition-all",
                reportSubTab === 'consignment' ? "bg-accent-500 text-white shadow-lg premium-shadow" : "text-coffee-400 hover:text-coffee-600"
              )}
            >
      ...
      {reportSubTab === 'transactions' ? (
        <div className="space-y-8">
          <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            <div>
              <p className="text-coffee-400 font-sans font-bold uppercase tracking-[0.2em] text-[10px] sm:text-xs mb-2">Ringkasan Penjualan</p>
              <h2 className="text-3xl sm:text-4xl font-serif text-coffee-950 tracking-tight">
                Laporan <span className="text-coffee-400">Transaksi</span>
              </h2>
            </div>
            <div className="flex flex-wrap items-center gap-4">
              {user.role === 'admin' && (
                <button 
                  ...
                  className="px-8 py-3 bg-accent-600 text-white rounded-2xl text-[10px] font-sans font-bold uppercase tracking-widest shadow-xl shadow-accent-950/20 hover:bg-accent-700 transition-all flex items-center gap-3 premium-shadow"
                >
                  <Download size={18} />
              ...
              <div className="flex bg-white/50 backdrop-blur-sm p-1.5 rounded-2xl border border-coffee-100 shadow-sm">
                <button 
                  ...
                  className={cn(
                    ...
                    reportFilter === 'daily' ? "bg-accent-500 text-white shadow-lg premium-shadow" : "text-coffee-400 hover:text-coffee-600"
                  )}
                >
                  Harian
                </button>
                <button 
                  ...
                  className={cn(
                    "px-6 py-2.5 rounded-xl text-[10px] font-sans font-bold uppercase tracking-widest transition-all",
                    reportFilter === 'monthly' ? "bg-coffee-950 text-white shadow-lg premium-shadow" : "text-coffee-400 hover:text-coffee-600"
                  )}
                >
                  Bulanan
                </button>
              ...
              <div className="relative group">
                <Calendar className="absolute left-4 top-1/2 -translate-y-1/2 text-coffee-300 group-focus-within:text-coffee-500 transition-colors pointer-events-none" size={16} />
                <input 
                  type="date" 
                  value={reportDate}
                  onChange={(e) => {
                  ...
                  className="bg-white border border-coffee-100 rounded-2xl pl-12 pr-6 py-3.5 text-sm font-sans font-semibold text-coffee-950 focus:outline-none focus:ring-2 focus:ring-coffee-500/20 focus:border-coffee-500 shadow-sm transition-all"
                />
              </div>
              <button 
                onClick={() => exportToCSV(
                ...
                className="flex items-center gap-3 bg-white border border-coffee-100 text-coffee-600 px-6 py-3.5 rounded-2xl text-[10px] font-sans font-bold uppercase tracking-widest hover:bg-coffee-50 transition-all shadow-sm"
              >
                <FileDown size={18} />
                Export CSV
              </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="glass-card p-8 bg-emerald-50/50 border-emerald-100 text-coffee-950 relative overflow-hidden group">
              ...
              <p className="text-emerald-700 text-[10px] sm:text-xs font-sans font-bold uppercase tracking-[0.2em] mb-4">Total Penjualan</p>
            ...
            <div className="glass-card p-8 relative overflow-hidden group">
              ...
              <p className="text-coffee-400 text-[10px] sm:text-xs font-sans font-bold uppercase tracking-[0.2em] mb-4">Jumlah Transaksi</p>
              <p className="text-3xl sm:text-4xl font-serif text-coffee-950">
                {transactions
                  .filter(tx => tx.type === 'income' && tx.category === 'Sales' && (
                    reportFilter === 'daily' 
                      ? formatDate(tx.date, 'yyyy-MM-dd', appSettings.timezone) === reportDate
                ...
                } <span className="text-sm font-sans font-medium text-coffee-400 not-italic">Order</span>
              </p>
            </div>
            <div className="glass-card p-8 relative overflow-hidden group">
              <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
              ...
              <p className="text-coffee-400 text-[10px] sm:text-xs font-sans font-bold uppercase tracking-[0.2em] mb-4">Metode Terpopuler</p>
              <p className="text-xl sm:text-2xl font-serif text-coffee-950">
                {(() => {
        ...
        <div className="space-y-8">
          <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              <p className="text-coffee-500 font-medium uppercase tracking-widest text-[10px] sm:text-xs mb-1">Ringkasan Penjualan</p>
              <h2 className="text-3xl sm:text-4xl font-serif font-bold text-coffee-950">Ringkasan Hari Ini</h2>
            </div>
            <button 
          ...
          {dailySummary && (
            ...
            <div className="glass-card p-6 bg-emerald-50 border-emerald-100">
              <p className="text-emerald-700 text-[10px] sm:text-xs font-bold uppercase tracking-widest mb-2">Total Pendapatan</p>
              <p className="text-2xl sm:text-3xl font-bold text-emerald-600">{formatIDR(dailySummary.totalRevenue)}</p>
            </div>
            <div className="glass-card p-6 bg-blue-50 border-blue-100">
              <p className="text-blue-700 text-[10px] sm:text-xs font-bold uppercase tracking-widest mb-2">Total Pesanan</p>
              <p className="text-2xl sm:text-3xl font-bold text-blue-600">{dailySummary.totalOrders} <span className="text-sm font-medium">Order</span></p>
            </div>
            <div className="glass-card p-6 bg-amber-50 border-amber-100">
              <p className="text-amber-700 text-[10px] sm:text-xs font-bold uppercase tracking-widest mb-2">Item Terjual</p>
              <p className="text-2xl sm:text-3xl font-bold text-amber-600">{dailySummary.totalItems} <span className="text-sm font-medium">Pcs</span></p>
            </div>
              </div>
