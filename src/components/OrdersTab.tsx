                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          ...
                          cartItem ? "border-coffee-600 bg-coffee-50/30" : "border-transparent"
                        )}
                      >
                        {/* Image Section */}
                        ...
                        <div className="p-3 min-[400px]:p-4 flex-1 flex flex-col min-w-0">
                          ...
                          <div className="mt-auto flex justify-between items-center">
                            ...
                            <div className={cn(
                              ...
                              cartItem ? "bg-coffee-900 text-white" : "bg-coffee-50 text-coffee-400 group-hover:bg-coffee-100"
                            )}>
                              {cartItem ? <Check size={14} /> : <Coffee size={14} />}
                            </div>
                          </div>
                        </div>
                      </button>
